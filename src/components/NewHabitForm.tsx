...
export function NewHabitForm() {
  ...
  function handlToggleWeekDay(weekDay: number) {
    // in react we dont edit a state, we set a new state
    // that's why we can't just find each is already there and exclud it
    // here, we filter the array with the one who should not be inside it and the set a new state with this new filtered array
